...
$mysql = mysqli_connect('192.168.10.10', 'homestead', 'secret', 'homestead');
$mssql = sqlsrv_connect('192.168.1.42\SQLEXPRESS, 49160', ["database" => "sa2010", "UID" => "sa", "pwd" => "Consorcio2018"]);
