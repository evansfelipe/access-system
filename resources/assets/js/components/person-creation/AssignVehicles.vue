...
export default {
    ...
    data: function() {
        return {
            ...
            vehiclesList: [],
            othersVehicles:  this.vehicles.filter(vehicle => vehicle.company_id != this.companyid),
            companyVehicles: this.vehicles.filter(vehicle => vehicle.company_id == this.companyid),
            search: "",
        };
    },
    mounted() {
    ...
    methods: {
        ...
        save: function() {
            ...
            this.othersVehicles.forEach(element => {
                if(element.picked)
                    data.push(element.id);
            });
    ...
    watch: {
        ...
        companyid: function() {
            this.othersVehicles =  this.vehicles.filter(vehicle => vehicle.company_id != this.companyid);
            this.companyVehicles = this.vehicles.filter(vehicle => vehicle.company_id == this.companyid);
            if(this.companyVehicles.length > 0) {
                this.unfilteredVehiclesList = this.companyVehicles;
                this.vehiclesList = this.companyVehicles;
            }
