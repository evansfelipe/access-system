<form enctype="multipart/form-data" action="{{ $route }}" method="POST" class="no-select">
    @csrf
    @if(isset($method))
        @method($method)
    @endif
    ...
    {{-- Submit --}}
    @submitbutton(['id' => 'create-person-submit', 'color' => 'success']){{ $button_text or 'Guardar' }}@endsubmitbutton
</form>